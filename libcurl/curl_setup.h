...
#  include <winerror.h>
#  include <windows.h>
#  if defined(__POCC__) && !defined(__FSDK__)
#    error "To compile this library you need frankie's SDK (Installer download: https://github.com/Frankie-PellesC/fSDK/raw/master/fSDK.exe)"
#  endif
